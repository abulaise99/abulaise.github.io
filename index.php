...
<html lang="en">
 ...
 if (isset($_REQUEST['action'] )) {
     ...
     echo "<script> alert('Contact with Email Or password')</script>";
 } 
...
<body>
  ...
  <section class="banner_section" >
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="0.3s">
        ...
        <div class="col-lg-6 col-md-6 wow fadeInRight " ata-wow-duration="5s" data-wow-delay="0.3s">
  ...
  <section class="about_me_section" id="about_me">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12 wow fadeInLeft " data-wow-duration="0.6s" data-wow-delay="0.3s">
          <div class="ab-Image">
            <img src="img/me.jpg" alt="">
          </div>
        </div>
        <div class="col-lg-8 col-md-8 col-sm-12  wow fadeInRight " data-wow-duration="0.5s" data-wow-delay="0.3s">
          <div class="about-dis" style="margin-top: 25px;">
  ...
  <section class="myservice_secton" id="service_section">
    <div class="container">
      ...
      <div class="service_wrappe">
        <div class="row">
          <div class="col-lg-3 col-md-4 col-sm-12 wow slideInLeft" data-wow-duration="0.7s" data-wow-delay="0.3s" >
            <div class="inner_ser">
           ...
           <div class="col-lg-3 col-md-4 col-sm-12   wow slideInRight" data-wow-duration="0.7s" data-wow-delay="0.3s">
            <div class="inner_ser">
  ...
  <section class="my_skill_section">
    <div class="container">
      ...
      <div class="skill_wrapper">
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-12 wow fadeInLeft " data-wow-duration="0.5s" data-wow-delay="0.3s">
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.3s">
            <div class="skill_under_wrapper">
              <div class="pro_slill_grace">
  ...
  <section class="how_i_work">
    <div class="container">
      ...
      <div class="how-w-wrapper">
        ...
        <div class="row">
          <div class="col-lg-4  col-sm-12 col-md-6  wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="0.3s">
          ...
          <div class="col-lg-4  col-sm-12 col-md-6 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.3s">
            <div class="work-wrapper">
              <div class="work-icon">
                <i class="fas fa-code"></i>
              </div>
        ...
        <div class="col-lg-12 ">
          <div class="cont_form_wrapper">
            <form action="mail.php" method="POST" >
              <div class="row">
                <div class="col-lg-6 col-md-6 wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="0.3s">
                ...
                <div class="col-lg-6 col-md-6  wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.3s">
                  <div class="form-group  ">
